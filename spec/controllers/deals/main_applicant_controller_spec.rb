...
RSpec.describe Deals::MainApplicantController, type: :controller do
  ...
  describe 'PUT#update' do
    context 'when information step' do
      ...
      context 'with valid attributes' do
        ...
        it 'updates deal and redirect to next step' do
          expect(response).to redirect_to(deal_main_applicant_path(deal, 'income'))
        end
      end
    end
    ...
    context 'when income step' do
      ...
      context 'with valid attributes' do
        ...
        it 'updates deal and redirect to next step' do
          expect(response).to redirect_to(deal_main_applicant_path(deal, 'assets'))
        end
      end
    end
    ...
    context 'when assets step' do
      ...
      context 'with valid attributes' do
        ...
        it 'updates deal and redirect to next step' do
          expect(response).to redirect_to(deal_main_applicant_path(deal, 'liabilities'))
        end
      end
    end
    ...
    context 'when liabilities step' do
      ...
      context 'with valid attributes' do
        ...
        it 'updates deal and redirect to next step' do
          expect(response).to redirect_to(deal_main_applicant_path(deal, 'wicked_finish'))
        end
      end
    end
  end
